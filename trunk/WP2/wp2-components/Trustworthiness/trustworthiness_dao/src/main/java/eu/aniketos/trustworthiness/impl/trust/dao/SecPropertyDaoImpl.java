...
public class SecPropertyDaoImpl  extends JpaDaoSupport implements SecPropertyDao {
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.SecPropertyDao#addSecProperty(eu.aniketos.trustworthiness.impl.trust.pojo.SecProperty)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.SecPropertyDao#updateSecProperty(eu.aniketos.trustworthiness.impl.trust.pojo.SecProperty)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.SecPropertyDao#getSecPropertysByServiceId(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.SecPropertyDao#deleteSecProperty(eu.aniketos.trustworthiness.impl.trust.pojo.SecProperty)
	 */
