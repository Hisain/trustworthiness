package eu.aniketos.wp2.components.trustworthiness.mock.test.trust.alerts;

import org.apache.log4j.Logger;
import org.osgi.service.event.Event;
import org.osgi.service.event.EventHandler;

public class NotificationTest implements EventHandler {

	private static Logger logger = Logger.getLogger(NotificationTest.class);
