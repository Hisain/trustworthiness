...
public class ThreatLevelDaoImpl  extends JpaDaoSupport implements ThreatLevelDao {
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.ThreatLevelDao#addThreatLevel(eu.aniketos.trustworthiness.impl.trust.pojo.ThreatLevel)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.ThreatLevelDao#updateThreatLevel(eu.aniketos.trustworthiness.impl.trust.pojo.ThreatLevel)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.ThreatLevelDao#getThreatLevelsByServiceId(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.trustworthiness.trust.dao.ThreatLevelDao#deleteThreatLevel(eu.aniketos.trustworthiness.impl.trust.pojo.ThreatLevel)
	 */
