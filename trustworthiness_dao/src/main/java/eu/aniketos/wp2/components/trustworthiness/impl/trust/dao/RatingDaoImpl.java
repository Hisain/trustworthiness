...
public class RatingDaoImpl  extends JpaDaoSupport implements RatingDao {
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#addRating(eu.aniketos.wp2.components.trustworthiness.impl.trust.pojo.Rating)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#updateRating(eu.aniketos.wp2.components.trustworthiness.impl.trust.pojo.Rating)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#getRatingsByServiceId(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#deleteRating(eu.aniketos.wp2.components.trustworthiness.impl.trust.pojo.Rating)
	 */
