...
public class QoSMetricDaoImpl extends JpaDaoSupport implements QoSMetricDao {
	 ...
	 * 
	 * @see
	 * eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#addRating
	 * (eu.aniketos.wp2.components.trustworthiness.impl.trust.pojo.Rating)
	 */
	 ...
	 * 
	 * @see
	 * eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#updateRating
	 * (eu.aniketos.wp2.components.trustworthiness.impl.trust.pojo.Rating)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#
	 ...
	 * 
	 * @see
	 * eu.aniketos.wp2.components.trustworthiness.trust.dao.RatingDao#deleteRating
	 * (eu.aniketos.wp2.components.trustworthiness.impl.trust.pojo.Rating)
	 */
